...
export default function ImageUpload({
  ...
  return (
    <div
      ...
      {...getRootProps({
        className:
          'border aspect-square w-[150px] h-[150px] text-secondary-500 border-dashed border-secondary-500 rounded-[6px] p-1 relative h-[120px] data-[is-dragactive=true]:border-primary-500 data-[is-dragactive=true]:border-solid transition-all duration-200 ease-in-out data-[is-dragactive=true]:bg-primary/50',
      })}
    >
