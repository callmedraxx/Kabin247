        ...
        <div className="grid grid-cols-1 @5xl:grid-cols-8 gap-6 p-6 @5xl:p-12">
          ...
          <div className="col-span-1 @5xl:col-span-6">
            ...
            <div className="grid grid-cols-2 @md:grid-cols-2 @3xl:grid-cols-4 gap-3 mb-4">
              ...
              <AnalyticsCard
                size="large"
                title={t('Awaiting Vendor Confirmation')}
                icon={<Check variant="Bulk" size={24} className="text-blue-400" />}
              ...
              <AnalyticsCard
                ...
                icon={<User variant="Bulk" size={24} className="text-blue-400" />}
              ...
              <AnalyticsCard
                size="large"
                title={t('Awaiting Client Confirmation')}
                icon={<Check variant="Bulk" size={24} className="text-blue-400" />}
              ...
              <AnalyticsCard
                ...
                icon={<TickCircle variant="Bulk" size={24} className="text-blue-400" />}
            ...
            <div className="grid grid-cols-1 @md:grid-cols-2 @xl:grid-cols-3 gap-3">
              <AnalyticsCard
                ...
                icon={<TruckFast variant="Bulk" size={24} className="text-red-400" />}
